 ...
 *
 * Types support added by Josha Munnik
 */
...
var argv = nomnom
  .option('file-filters', {
    abbr: 'f',
    'default': '.*\\.(clj|coffee|cs|dart|erl|go|java|js|php?|py|rb|ts|pm)$',
  ...
  .option('silent', {
    flag: true,
    'default': false,
    help: 'Turn all output off.'
  })

  .option('simulate', {
    flag: true,
    'default': false,
    help: 'Execute but not write any file.'
  })
...
if (typeof options.ignoreGroups === 'string') {
  options.ignoreGroups = [options.ignoreGroups];
}
